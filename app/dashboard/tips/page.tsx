...
export default function TipsPage() {
  ...
  const methodColor: Record<string, string> = { cash: "#10B981", card: "#6366F1", online: "#F59E0B" };
      ...
      <div style={{ padding: "28px 24px", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14, marginBottom: 24 }}>
          {[
            ...
            { label: "This Month", value: `£${tips.filter(t => new Date(t.created_at).getMonth() === new Date().getMonth()).reduce((s,t) => s + t.amount, 0).toFixed(2)}`, icon: "📅", color: "#6366F1" },
