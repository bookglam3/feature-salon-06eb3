                          ...
                          <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                            ...
                            {e.status === "waiting" && (e.client_phone || e.client_email) && (
                              <button
                                ...
                                style={{ padding: "5px 10px", background: notifying === e.id ? "#F1F5F9" : "linear-gradient(135deg,#C9A24B,#C2185B)", border: "none", borderRadius: 8, fontSize: 12, fontWeight: 700, cursor: notifying === e.id ? "not-allowed" : "pointer", color: notifying === e.id ? "#94A3B8" : "#fff", whiteSpace: "nowrap" }}
                              >
